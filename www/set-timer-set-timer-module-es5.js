...
var SetTimerPageModule = /** @class */ (function () {
    function SetTimerPageModule() {
    }
...
var SetTimerPage = /** @class */ (function () {
    function SetTimerPage(Auth, http, router, route) {
        this.Auth = Auth;
        this.http = http;
        this.router = router;
        this.route = route;
    }
    SetTimerPage.prototype.showRest = function (event) {
        ...
        var tabata = tarVal.substring(14, 19);
        // let m = +tabata.split(':')[0];
        var s = +tabata.split(':')[1];
        var secondCount = s;
    ...
    SetTimerPage.prototype.startTabata = function (event) {
        var target = event.target;
        var countdown = target.querySelector('#countdown').value;
        var tabata = target.querySelector('#tabata').value;
        var url = window.location.href;
        var id = url.substring(url.lastIndexOf('/') + 1);
        this.Auth.passData(countdown, tabata, id);
        // console.log("start tabata", countdown);
    };
    SetTimerPage.prototype.backPage = function () {
        this.router.navigate(['/home/']);
    };
    SetTimerPage.prototype.ngOnInit = function () {
    };
    SetTimerPage.ctorParameters = function () { return [
...
//# sourceMappingURL=set-timer-set-timer-module-es5.js.map